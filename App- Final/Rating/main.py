...
class Logout(Screen, FloatLayout, App):
	...
	def on_press(self, instance):
		...
		shuffle(stimComb)
		saveStim["up"] = stimComb[0:45]
		saveStim["down"] = stimComb[45:90]
		shuffle(stimComb)
		saveStim["right"] = stimComb[0:45]
		saveStim["left"] = stimComb[45:90]
		with open("./Data/current_stim.json", 'w') as f: # modify according to your local path
			json.dump(saveStim, f)
