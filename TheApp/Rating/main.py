...
class Logout(Screen, FloatLayout, App):
	...
	def on_press(self, instance):
		...
		with open("C:\\Users\\participant\\Desktop\\Mousetrack-main\\TheApp\\Rating\\Data\\p"+login.username.text+"_rating.json", 'w') as f: # modify according to your local path
		...
		with open("C:\\Users\\participant\\Desktop\\Mousetrack-main\\TheApp\\Rating\\Data\\current_stim.json", 'w') as f: # modify according to your local path 
